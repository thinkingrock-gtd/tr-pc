 ...
 * the component.
 */
public final class ComponentSizer extends MouseAdapter {
    ...
    /**
     * Convenience constructor. All borders are resize-able in increments of a
     * single pixel. Components must be registered separately.
     */
    public ComponentSizer() {
        this(new Insets(5, 0, 5, 0), new Dimension(1, 1));
    }
     ...
     */
    public ComponentSizer(Component... components) {
        this(new Insets(5, 0, 5, 0), new Dimension(1, 1), components);
    }

    /**
     * Convenience constructor. Eligible borders are resize-able in increments
     * of a single pixel. Components can be registered when the class is created
     ...
     * @param components components to be automatically registered
     */
    public ComponentSizer(Insets dragInsets, Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ComponentSizer(Insets dragInsets, Dimension snapSize, Component... components) {
     ...
     * for any size will imply that the border is not resize-able. Otherwise the
     * appropriate drag cursor will appear when the mouse is inside the
     * resize-able border area.
     *
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        //  Mouse is no longer over a resize-able border

        if (direction == 0) {
            source.setCursor(sourceCursor);
        } else // use the appropriate resize-able cursor
        {
...
// JIM            
//            if (source instanceof EventView) {
//                ((EventView)source).updateTime();
//            }
        }
    }
...
//        // JIM. 
//        if (source instanceof EventPanel) {
//            ((EventPanel)source).updateTime();
//        }
    }
