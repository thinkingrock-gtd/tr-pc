 ...
 * @author Jeremy Moore
 */
public class ReportImpl2 extends au.com.trgtd.tr.extract.Extract {

    private static final String ID = "tr.reports.pocketmod.2";
    ...
    public String getName() {
        return getString("CTL_ReportAction2");
    }
