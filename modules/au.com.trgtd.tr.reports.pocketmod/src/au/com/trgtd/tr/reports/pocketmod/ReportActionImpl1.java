 ...
 * @author Jeremy Moore
 */
public final class ReportActionImpl1 extends ReportAction {

    private static final String HELP_CTX = "tr.reports.pocketmod";
    
    /** Constructs a new instance. */
    public ReportActionImpl1() {
        super();
        setIcon(Icons.PDF);
    }
    ...
    public String getName() {
        return NbBundle.getMessage(getClass(), "CTL_ReportAction1");
    }
