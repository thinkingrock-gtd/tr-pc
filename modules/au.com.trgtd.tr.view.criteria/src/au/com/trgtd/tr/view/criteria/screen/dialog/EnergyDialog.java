...
/**
 * Dialog for creating and modifying energy values.
 *
 * @author Jeremy Moore
 */
public class EnergyDialog extends JDialog {
    ...
    private Mode mode;
    private EnergyDialogPanel panel;
    private Value value;
    ...
    private void construct() {
        ...
        panel = new EnergyDialogPanel(submitButton);
    ...
    private void setMode(Mode mode) {
        this.mode = mode;
        if (mode == Mode.CREATE) {
            setTitle(NbBundle.getMessage(getClass(), "create.energy")); 
            submitButton.setText(NbBundle.getMessage(getClass(), "add"));
        } else {
            setTitle(NbBundle.getMessage(getClass(), "modify.energy")); 
    ...
    private void submit() {
        ...
        data.getEnergyCriterion().values.add(new Value(panel.getTitle(), data));            
