...
public class PriorityChildren extends Children.Keys<Value> implements Observer {
    ...
    public PriorityChildren(OutlineView view, ExplorerManager em) {
        this.view = view;
        
        this.em = em;
        Data data = DataLookup.instance().lookup(Data.class);
        this.values = (data == null) ? null : data.getPriorityCriterion().values;
    ...
    protected Node[] createNodes(Value value) {
        return new Node[]{new PriorityNode(value)};
    }
    ...
    private class IndexImpl extends Index.Support {
        ...
        public Node[] getNodes() {
            return PriorityChildren.this.getNodes();
        }
        ...
        public void moveUp(final int i) {
            ...
            view.getOutline().requestFocusInWindow();
            view.getOutline().setRowSelectionInterval(i - 1, i - 1);
        }
