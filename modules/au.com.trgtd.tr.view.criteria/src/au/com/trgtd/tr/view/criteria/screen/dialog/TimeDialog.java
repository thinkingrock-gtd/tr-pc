...
/**
 * Dialog for creating and modifying time values.
 *
 * @author Jeremy Moore
 */
public class TimeDialog extends JDialog {
    ...
    private void construct() {
        ...
        panel = new TimeDialogPanel(submitButton);
    ...
    private void setMode(Mode mode) {
        this.mode = mode;
        if (mode == Mode.CREATE) {
            setTitle(NbBundle.getMessage(getClass(), "create.time")); 
            submitButton.setText(NbBundle.getMessage(getClass(), "add"));
        } else {
            setTitle(NbBundle.getMessage(getClass(), "modify.time")); 
    ...
    private void submit() {
        ...
        data.getTimeCriterion().values.add(new Value(panel.getTitle(), data));            
