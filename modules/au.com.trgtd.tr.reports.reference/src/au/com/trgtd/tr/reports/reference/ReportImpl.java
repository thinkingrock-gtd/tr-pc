...
import au.com.trgtd.tr.extract.ExtractReferences;
...
public class ReportImpl extends au.com.trgtd.tr.extract.Extract {
    ...
    public void process(Data data) throws Exception {
        ...
        if (paramGroup.getValue().equals("true")) {
            ...
            rptfile = (paper == PaperSize.Letter) ? Resources.FILE_RPT_REFS_GROUP_LTR : Resources.FILE_RPT_REFS_GROUP_A4;
        } else {
            PaperSize paper = paramPaper.getValue().equals("letter") ? PaperSize.Letter : PaperSize.A4;
            rptfile = (paper == PaperSize.Letter) ? Resources.FILE_RPT_REFS_LTR : Resources.FILE_RPT_REFS_A4;
        }
