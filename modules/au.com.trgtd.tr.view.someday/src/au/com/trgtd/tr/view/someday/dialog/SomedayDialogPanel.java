...
/**
 * Someday/Maybe dialog panel.
 *
 * @author Jeremy Moore
 */
public class SomedayDialogPanel extends JPanel {

    /** Constructs a new instance. */
    public SomedayDialogPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tickleLabel = new TRLabel(NbBundle.getMessage(CLASS, "tickle"));
...
//        add(tickleField, "align left, wrap");
    ...
    public void setTickle(Date date) {
        tickleField.setDate(date);
    }

    public Date getTickleDate() {
        return tickleField.getDate();
    }
    ...
    private static final Class CLASS = SomedayDialogPanel.class;
