...
import au.com.trgtd.tr.sync.iphone.SyncMsg103;
import au.com.trgtd.tr.sync.iphone.SyncMsg103.MsgActionUpdate;
import au.com.trgtd.tr.sync.iphone.SyncMsg103.MsgHandshake;
import au.com.trgtd.tr.sync.iphone.SyncMsg103.MsgThought;
 ...
 * @author Jeremy Moore
 */
public class DBoxSync103 extends Thread {

    private final static Logger LOG = Logger.getLogger(DBoxSync103.class.getName());
...
//      dboxFileRecv = getDBoxFileRecv();
        ...
        handler = new SyncHandler(reader, writer, null);
        ...
        todo = 0;
        todo += handshake.nbrActions * 2;   // double for updating actions
        todo += handshake.nbrThoughts;
        todo += contexts.size();
        todo += topics.size();
        todo += actions.size();
        todo += times.size();
    ...
    private MsgHandshake getRecvHandshake() throws Exception {
        ...
        // parse handshake
        MsgHandshake hs = SyncMsg103.getHandshakeMsg(reader.readLine());
        if (hs == null) {
    ...
    private void syncUp(MsgHandshake hsMsg) throws Exception {
        ...
        newThoughtMsgs = new MsgThought[hsMsg.nbrThoughts];
        updActionMsgs = new MsgActionUpdate[hsMsg.nbrActions];
    ...
    private String getSendHandshake() {
        return (SyncHandler.VERSION + "|HELLO"
